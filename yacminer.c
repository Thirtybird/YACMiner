...
static const char def_conf[] = "yacminer.conf";
...
retry_pool:
	...
	while (42) {
		...
		/* cURL seems to leave an excessive amount of connections open
		 * which eventually consumes all available file descriptors.
		 * Try to fix that. */
...
int main(int argc, char *argv[])
{
	...
	strcpy(opt_kernel_path, YACMINER_PREFIX);
